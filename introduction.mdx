...
- **3 unified tools** — `remember` (save / update / delete), `recall` (search / file history / overview), `read_smart` (token-saving reads)
...
4. **Over time**, auto-consolidation compresses cold memories into learning-layer summaries while preserving caveats
...
<CardGroup cols={2}>
  ...
  <Card title="Tools Reference" icon="wrench" href="/tools/remember">
    Full API reference for all 3 tools
  </Card>
</CardGroup>
